 ...
 * @return array
 */
function surgeries_create($req, $res, $date, $op_type, $first, $second, $patient_id, $patient_name, $pathology, $comments, $uid) {
	$date = formatDate ( $date );
	$query = 'INSERT INTO surgeries (`date`, `op_type`, `first`, `second`, `patient_id`, `patient_name`, `pathology`, `comments`, `uid`) VALUES (\'' . $date . '\', \'' . $op_type . '\',\'' . $first . '\', \'' . $second . '\', \'' . $patient_id . '\', \'' . $patient_name . '\', \'' . $pathology . '\', \'' . $comments . '\', \'' . $uid . '\')';
